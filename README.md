...
- **Zero Dependencies**: Pure HTML/CSS/JS. Just double-click `index.html` to play entirely offline.
...
1. **Open the Game**: Double click `index.html` in your browser.
...
- **纯单机离线**：无需任何外部依赖，双击 `index.html` 即可运行。
